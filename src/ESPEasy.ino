...
#define DEFAULT_NAME        "espEasy1"          // Enter your device friendly name
#define DEFAULT_SSID        "cytrynowa_wro"     // Enter your network SSID
#define DEFAULT_KEY         "limonkowy"         // Enter your network WPA key
#define DEFAULT_SERVER      "192.168.0.142"     // Enter your Domoticz Server IP address
#define DEFAULT_PORT        8080                // Enter your Domoticz Server port value
#define DEFAULT_DELAY       60                  // Enter your Send delay in seconds
#define DEFAULT_AP_KEY      "limonkowy"         // Enter network WPA key for AP (config) mode
